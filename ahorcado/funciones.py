...
def obtenPalabras(lista:list)->list:
    '''
...
def adivinaLetra(abc:dict, palabra:str, letras_adivinadas:set, turnos:int):
    '''
...
if __name__== '__main__':
    ...
    lista_palabras = obtenPalabras(lista_oraciones)
    ...
    adivinadas = set()
    t = 5 # oportunidades
    t = adivinaLetra(abcdario, p, adivinadas, t)
    print(t)
    t = adivinaLetra(abcdario, p, adivinadas, t)
    print(t)
