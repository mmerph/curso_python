...
class Team:
    ...
    def __str__(self):
        ...
        return f"Team(name= '{self.name}', sport = {self.sport}, plyaers={self.players})"
    ...
    def to_json(self)-> dict:
        ...
        return {"name":self.name, "sport":self.sport, "players":[p.to_json() for p in self.players]}
